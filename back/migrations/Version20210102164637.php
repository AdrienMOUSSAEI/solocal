...
final class Version20210102164637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "23.99, 3, '2020-12-18', '/mediaObject/5fdcda81991a6.jpg', '', 'Rose',1);");
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "6.49, 4, '2020-11-19', '/mediaObject/5fdcda81991a7.jpg', '2M', 'Red',2);");
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "6.49, 4, '2020-12-06', '/mediaObject/5fdcda81991a8.jpg', '3M', 'Carbone et Noir',3);");
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "12.99, 4, '2020-08-18', '/mediaObject/5fdcda81991a9.jpg', '', 'Blanc',4);");
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "9.49, 4, '2020-05-19', '/mediaObject/5fdcda81991a10.jpg', '', 'Black',5);");
        ...
        $this->addSql("INSERT INTO `article` (`category`, `sub_category`, `title`, `description`, `price`, `note`, `creation_date`, `image`, `size`, `color`, `image_file_id`) "
                ...
                . "213, 4, '2020-12-24', '/mediaObject/5fdcda81991a11.jpg', '', 'Peacock Blue',6);");        
    }
